...
import { updateAlertThreshold } from "@/app/(app)/settings/actions";
...
// Planning & alert settings: the balance cushion under which the daily
// cash-flow projection warns. Separate card from regional preferences — these
// change money behaviour, not formatting.
