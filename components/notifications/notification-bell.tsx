...
// Notification bell. Desktop anchors a dropdown to the bell; on mobile that
// anchored popup is cramped and hard to dismiss, so the same panel opens as a
// top sheet sliding under the header instead (the bell lives at the top edge).
